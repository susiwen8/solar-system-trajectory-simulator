...
export const messages = {
  en: {
    ...
    spacexRecoverySubtitle: "A guided 3D explainer for stage separation, boostback, and first-stage landing.",
    recoveryPageBody: "Use the synchronized scene and playback controls to inspect liftoff, separation, return, and touchdown.",
    ...
    recoverySceneBody: "Track liftoff, stage separation, boostback, and landing in the synchronized 3D theatre.",
    recoverySceneFallbackTitle: "This environment cannot display the 3D view.",
    recoverySceneFallbackBody: "The current phase and recovery story stay visible even when WebGL is unavailable.",
  ...
  zh: {
    ...
    spacexRecoverySubtitle: "通过 3D 回收演示理解分离、返向点火和一级着陆。",
    recoveryPageBody: "用同步场景和回放控件查看起飞、分离、折返与回收着陆的完整过程。",
    recoveryPhaseLabel: "当前阶段",
    recoveryPlaybackLabel: "回放控制",
    recoveryTimelineLabel: "时间线",
    recoverySceneLabel: "回收场景",
    recoverySceneBody: "在同步的 3D 剧场里查看起飞、分离、返向点火和一级回收。",
    recoverySceneFallbackTitle: "当前环境无法显示 3D 画面。",
    recoverySceneFallbackBody: "即使 WebGL 不可用，当前阶段和回收叙事也会继续显示。",
