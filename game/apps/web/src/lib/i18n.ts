...
export const messages = {
  en: {
    ...
    spacexRecoverySubtitle: "Recovery route shell placeholder.",
    recoveryPageBody: "Scrub the launch-to-landing sequence with accessible playback controls.",
  ...
  zh: {
    ...
    spacexRecoverySubtitle: "回收任务占位页",
    recoveryPageBody: "通过可访问的回放控制拖动发射到着陆的整个序列。",
