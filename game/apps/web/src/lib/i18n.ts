...
export const messages = {
  en: {
    ...
    recoveryPhaseBody: "The card below summarizes the current moment in the recovery demo.",
    recoveryPlaybackLabel: "Playback Controls",
    recoveryTimelineLabel: "Timeline",
    recoverySceneLabel: "Recovery Scene",
    recoverySceneBody: "A lightweight scene stub stays here until the dedicated 3D view lands.",
  ...
  zh: {
    ...
    recoveryPhaseBody: "下方卡片会概述回收演示中的当前时刻。",
    recoveryPlaybackLabel: "回放控制",
    recoveryTimelineLabel: "时间线",
    recoverySceneLabel: "回收场景",
    recoverySceneBody: "在专门的 3D 视图接入之前，这里先保留一个轻量场景占位。",
