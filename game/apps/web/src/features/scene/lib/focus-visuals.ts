...
export function computeFocusBodyVisualProfile(
  ...
  if (bodyId === "jupiter" || bodyId === "saturn") {
    return {
      ...
      haloScale: mode === "flyby-emphasis" ? 1.34 : mode === "approach-emphasis" ? 1.2 : 1.06,
      haloOpacity: mode === "flyby-emphasis" ? 0.3 : mode === "approach-emphasis" ? 0.2 : 0.08,
  ...
  return {
    ...
    atmosphereOpacity: mode === "flyby-emphasis" ? 0.22 : mode === "approach-emphasis" ? 0.2 : 0.06,
    haloScale: mode === "flyby-emphasis" ? 1.26 : mode === "approach-emphasis" ? 1.18 : 1.05,
    haloOpacity: mode === "flyby-emphasis" ? 0.24 : mode === "approach-emphasis" ? 0.2 : 0.06,
    bandCount: 0,
    bandOpacity: 0,
  };
}
