...
import MissionForm, { type MissionSubmission } from "../../mission/components/MissionForm";
import MissionSummary from "../../mission/components/MissionSummary";
import { buildArrivalCaptureModel } from "../../scene/lib/arrival-capture";
import type {
  BodyState,
  LaunchWindowRequest,
...
import EmptySolarPreview from "../../scene/components/EmptySolarPreview";
import SolarSystemScene from "../../scene/components/SolarSystemScene";
...
type SolarSystemSimulatorPageProps = {
  language: Language;
...
export default function SolarSystemSimulatorPage({ language, onLanguageChange }: SolarSystemSimulatorPageProps) {
